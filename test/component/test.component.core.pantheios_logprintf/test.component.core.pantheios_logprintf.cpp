 ...
 *
 *              Copyright (c) 2005-2017, Synesis Software Pty Ltd.
 *              All rights reserved.
 *
...
PANTHEIOS_EXTERN PAN_CHAR_T const PANTHEIOS_FE_PROCESS_IDENTITY[] = PANTHEIOS_LITERAL_STRING("test.component.core.pantheios_logprintf");
